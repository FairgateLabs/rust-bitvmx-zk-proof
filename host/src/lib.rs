...
pub fn prove_stark(input: u32, output_file: &str) {
    ...
    println!("The proof was executed, and the receipt saved to the file: {}", output_file);
...
pub fn prove_snark(receipt_fname: &str, output_groth_seal: &str) {
    ...
    println!("The proof was executed, and the seal was saved to the file: {}", output_groth_seal);
}
